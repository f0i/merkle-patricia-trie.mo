...
module {
    ...
    public func ethereumjsTests() {
        ...
        do {
            ...
            test "create a proof";
            var proof = Proof.createWithoutDB(trie, Key.fromText("key2bb"));
            assert proof == [
            ...
            proof := Proof.createWithoutDB(trie, Key.fromText("key1aa"));
            ...
            proof := Proof.createWithoutDB(trie, Key.fromText("key2bb"));
            ...
            proof := Proof.createWithoutDB(trie, myKey);
            ...
            proof := Proof.createWithoutDB(trie, Key.fromText("another"));
            val := Proof.verify(root, Key.fromText("key1aa"), proof);
        ...
        trie := Trie.put(trie, Key.fromText("key1aa"), Value.fromText("0123456789012345678901234567890123456789xx"));
        var root = Trie.rootHash(trie);
        var proof = Proof.createWithoutDB(trie, Key.fromText("key1aa"));
        ...
        proof := Proof.createWithoutDB(trie, Key.fromText("key1"));
        ...
        proof := Proof.createWithoutDB(trie, Key.fromText("key2"));
        val := Proof.verify(root, Key.fromText("key2"), proof);
        assert val == #included(Value.fromText("short"));

        proof := Proof.createWithoutDB(trie, Key.fromText("key3"));
